        ...
        <div className="hero-content flex-col ">
          ...
          <div className="card flex-shrink-0 w-full max-w-sm shadow-2xl bg-base-100">
            ...
            >
              ...
              <div className="flex items-center gap-2"><IoLogoGoogle></IoLogoGoogle>Continue with Google</div>
            </button>
            <button
            ...
            >
              ...
              <div className="flex items-center gap-2"><IoLogoGithub></IoLogoGithub>Continue with Github</div>
            </button>
          </div>
        </div>
      </div>
